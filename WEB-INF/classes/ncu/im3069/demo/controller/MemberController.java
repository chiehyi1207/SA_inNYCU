...
public class MemberController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String credit_card = jso.getString("credit_card");
        
        /** 建立一個新的會員物件 */
        Member m = new Member(email, password, phone, name, credit_card);
        
        /** 後端檢查是否有欄位為空值，若有則回傳錯誤訊息 */
        if(email.isEmpty() || password.isEmpty() || name.isEmpty() || credit_card.isEmpty() || phone.isEmpty()) {
            /** 以字串組出JSON格式之資料 */
            String resp = "{\"status\": \'400\', \"message\": \'欄位不能有空值/欄位不符\', \'response\': \'\'}";
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        Member m = new Member(id, email, phone, password, name, credit_card);
